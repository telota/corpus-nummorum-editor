        ...
        >
            ...
            <template v-slot:content-cards-body="slot">
                ...
                <Imager
                    ...
                    hide_text
                ></Imager>
                <div class="body-2 mt-3" v-html="'(DE)&ensp;' + attributes.name_de.content(slot.item)"></div>
                <div class="body-2 mt-3" v-html="'(EN)&ensp;' + attributes.name_en.content(slot.item)"></div>
                ...
                <div>
                    ...
                    >
                        <template v-slot:content>
                            <files 
                                :prop_item="{ id: slot.item.image, parent: 'Symbols' }"
                                class="mt-n2 mb-5"
